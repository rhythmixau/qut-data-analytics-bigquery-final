...
st.title("Mt. Egmont/Mt Taranaki Pest Control Effort")
...
FROM `goodnature.fct_nz_mt_egmont`
...
summary_fig.update_layout(barmode="group")
...
if len(data) > 0:
    ...
    fig = px.scatter_map(
        ...
        size_max=25,
        center={"lat": -39.258670, "lon": 174.374577 }, zoom=9,
        height=1500
    )
